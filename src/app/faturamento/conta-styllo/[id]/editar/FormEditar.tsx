  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 animate-fade-in">
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h1 className="text-3xl font-black text-slate-900 tracking-tight">Editar Conta Styllo</h1>
          <p className="text-sm text-slate-500 font-medium mt-1">Corrija os valores diários do banco.</p>
        </div>
      </div>
      ...
      <form action={actionAtualizar} className="bg-white p-6 sm:p-10 rounded-3xl shadow-sm border border-slate-200/80 space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="space-y-6">
             <h2 className="text-sm font-black text-slate-800 uppercase tracking-widest border-b border-slate-100 pb-2 flex items-center gap-2"><Landmark className="h-4 w-4 text-[#00bdf2]" /> Entradas (R$)</h2>
