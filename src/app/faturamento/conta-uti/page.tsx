...
export default async function ContaUtiPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* SISTEMA DE ABAS - CONTA UTI ATIVA */}
      <div className="flex gap-2 border-b border-slate-200 pb-2 overflow-x-auto">
         ...
         <Link href="/faturamento/conta-uti" className="px-4 py-2 bg-[#00bdf2] text-black font-black rounded-t-lg flex items-center gap-2 whitespace-nowrap shadow-sm">
