              ...
              <tbody>
                {registros.map((item) => (
                  <tr key={item.id} className="hover:bg-slate-50 transition-colors font-bold text-sm text-slate-800">
                    ...
                    <td className="p-3 border border-slate-400 bg-white"><BotoesAcao id={item.id} tabela="conta-uti" caminho="/faturamento/conta-uti" linkEditar={`/faturamento/conta-uti/${item.id}/editar`} /></td>
                  </tr>
                ))}
              </tbody>
              <tfoot>
