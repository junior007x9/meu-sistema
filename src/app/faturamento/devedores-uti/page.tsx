...
import { Plus, UserMinus, Wrench, Landmark, Activity, BookOpen } from 'lucide-react';
...
export default async function DevedoresUtiPage() {
  ...
  // Calcula o total apenas de quem ainda NÃO pagou
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <Link href="/faturamento/devedores-uti/novo" className="flex items-center gap-2 bg-red-500 hover:bg-red-600 text-white px-5 py-2.5 rounded-xl font-bold shadow-sm transition-transform hover:-translate-y-0.5">
          <Plus className="h-5 w-5" /> Novo Devedor
        </Link>
      </div>
