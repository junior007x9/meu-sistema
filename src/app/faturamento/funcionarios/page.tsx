...
import { Plus, Users, Wrench, Landmark, Activity, BookOpen, UserMinus, Handshake, CalendarDays, Scale, Wallet } from 'lucide-react';
                  ...
                  <table className="w-full text-center border-collapse min-w-[700px]">
                    <thead>
                      <tr className="bg-[#d7e3bc] text-black font-black text-xs">
                        <th className="p-2 border border-slate-400 w-48 text-left" rowSpan={2}>DESPESAS</th><th className="p-2 border border-slate-400" colSpan={dias.length}>VALOR DIÁRIO</th>
