  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <form action={criarOrdemServico} className="space-y-6">
        ...
        {/* BLOCO 1: CLIENTE E ARMAÇÃO (Resumido no código para focar na mudança) */}
        <div className="bg-white p-6 md:p-8 rounded-xl border border-slate-200 shadow-sm space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium text-slate-700 mt-4 mb-1">Relato do Defeito *</label>
            <textarea name="descricaoDefeito" required rows={2} className="w-full px-4 py-2 bg-slate-50 border border-slate-300 rounded-lg outline-none focus:ring-2 focus:ring-yellow-500"></textarea>
          </div>
        </div>

        {/* BLOCO 2: SERVIÇOS, TÉCNICO E PAGAMENTO */}
        <div className="bg-white p-6 md:p-8 rounded-xl border border-slate-200 shadow-sm space-y-4 relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            <div>
              <label className="block text-sm font-medium text-slate-700 mb-1">Serviço Realizado</label>
              <input type="text" name="servicoRealizado" className="w-full px-4 py-2.5 bg-slate-50 border border-slate-300 rounded-lg outline-none focus:ring-2 focus:ring-yellow-500" placeholder="Ex: Solda na haste..." />
            </div>
            <div>
              {/* CAMPO DO TÉCNICO AQUI */}
              <label className="block text-sm font-black text-emerald-700 mb-1 uppercase">Técnico Responsável</label>
              <select name="tecnico" className="w-full px-4 py-2.5 bg-emerald-50 border border-emerald-300 text-emerald-900 font-bold rounded-lg outline-none focus:ring-2 focus:ring-emerald-500">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-slate-50 p-3 rounded-lg border border-slate-200">
              <label className="flex items-center gap-2 text-xs font-bold text-slate-700 mb-2 uppercase"><QrCode className="h-4 w-4 text-emerald-600" /> PIX</label>
              <input type="number" step="0.01" name="valorPix" className="w-full px-3 py-2 bg-white border border-slate-300 rounded-md outline-none" />
            </div>
            <div className="bg-slate-50 p-3 rounded-lg border border-slate-200">
              <label className="flex items-center gap-2 text-xs font-bold text-slate-700 mb-2 uppercase"><Wallet className="h-4 w-4 text-amber-600" /> Espécie</label>
              <input type="number" step="0.01" name="valorEspecie" className="w-full px-3 py-2 bg-white border border-slate-300 rounded-md outline-none" />
            </div>
            <div className="bg-slate-50 p-3 rounded-lg border border-slate-200">
              <label className="flex items-center gap-2 text-xs font-bold text-slate-700 mb-2 uppercase"><CreditCard className="h-4 w-4 text-blue-600" /> Cartão</label>
              <input type="number" step="0.01" name="valorCartao" className="w-full px-3 py-2 bg-white border border-slate-300 rounded-md outline-none" />
            </div>
          </div>
        </div>
        ...
        <div className="flex justify-end gap-3 pb-10">
          ...
          <button type="submit" className="flex items-center gap-2 bg-yellow-500 hover:bg-yellow-600 text-slate-900 px-8 py-3 rounded-lg font-bold shadow-md transition-all hover:scale-105">
            <Save className="h-5 w-5" /> Salvar O.S.
          </button>
        </div>
      </form>
    </div>
