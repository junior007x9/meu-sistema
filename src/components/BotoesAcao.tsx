...
interface BotoesAcaoProps {
  id: number;
  tabela: 'cliente' | 'produto' | 'compras' | 'os' | 'simulacao' | 'preco' | 'conta' | 'joaozinho' | 'conta-styllo' | 'conta-uti'| 'carne' | 'devedores-uti'| 'indicados' | 'funcionarios' | 'diario' | 'balanco' | 'balanco-diario' | 'balanco-uti';
  caminho: string;
  linkEditar: string;
}
